...
<div class="container-fluid other_important_Instructions">
        ...
        <div class="conditions">
            ...
            <div class="begin_button"><button>{checkbox==true?<NavLink to={{pathname:'/QuestionAnswer/'+setids,data:{lang:lang}}}>i am ready to begin</NavLink>:<>i am ready to begin</>}</button></div>
        </div>
    </div>
    )
}